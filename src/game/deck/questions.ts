...
export const QUESTIONS: Question[] = [
  ...
  { id: 'n11', type: 'numeric', cat: 'general', text: 'About how many atoms are in your body?', unit: 'octillion', truth: 7, hint: 'A whole lot of atoms' },
  ...
  { id: 'n23', type: 'numeric', cat: 'general', text: 'How many times does the average person swallow in a day, roughly?', unit: 'hundred', truth: 20, hint: 'Mostly in your sleep' },
  ...
  { id: 'n29', type: 'numeric', cat: 'general', text: 'How many liters of blood does an adult have?', unit: 'l', truth: 5, hint: 'About 10 pints' },
  ...
  { id: 'n32', type: 'numeric', cat: 'general', text: 'How many times does your heart beat in an 80-year life?', unit: 'billion', truth: 3, hint: 'It never takes a day off' },
  ...
  { id: 'n36', type: 'numeric', cat: 'general', text: 'How many sunsets does the ISS crew see in one day?', unit: '', truth: 16, hint: 'One for every orbit' },
  ...
  { id: 's08', type: 'numeric', cat: 'funny', text: 'How long does it take to watch every Harry Potter movie, roughly?', unit: 'h', truth: 20, hint: 'One very long weekend' },
  ...
  { id: 'n40', type: 'numeric', cat: 'geo', text: 'How many grains of sand are on Earth, roughly?', unit: 'quadrillion', truth: 7500, hint: 'Beach math' },
  { id: 'g01', type: 'numeric', cat: 'geo', text: 'How many countries does Brazil share a land border with?', unit: '', truth: 10, hint: 'Every South American country except Chile and Ecuador' },
  ...
  { id: 'g04', type: 'numeric', cat: 'geo', text: 'How many lakes does Canada have, roughly?', unit: 'million', truth: 2, hint: 'More than all other countries combined' },
  ...
  { id: 'g07', type: 'numeric', cat: 'geo', text: 'How many countries share the Amazon river basin?', unit: '', truth: 9, hint: 'The world’s biggest rainforest under one roof' },
  ...
  { id: 'n20', type: 'numeric', cat: 'animals', text: 'How many birds are on Earth right now, roughly?', unit: 'billion', truth: 20, hint: 'Scientists actually counted' },
